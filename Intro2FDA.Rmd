...
<div class="red2">
<div class="centered">
<bdi style="font-size:350%;"><b>Functional Regression:<br>Estimation Through Basis Expansion</b>
</bdi>
</div>
</div>
...
Rewrite the functional regression model into an approximative multivariate reggression problem
<!-- $$ -->
<!-- \textstyle \int_a^b\beta(s)X_i(s)ds=\sum_{k=1}^Kc_k\int_a^bB_k(s)X_i(s)ds -->
<!-- $$ -->
<!-- $$ -->
<!-- \textstyle\phantom{\int_a^b\beta}=\sum_{k=1}^Kc_kx_{ik} -->
<!-- $$ -->
$$
\begin{align}
\int_a^b\beta(s)X_i(s)ds
&\approx\sum_{k=1}^Kc_k\int_a^bB_k(s)X_i(s)ds\\
&=\sum_{k=1}^Kc_kx_{ik}
\end{align}
$$
...
<!-- \textstyle  -->
<!-- \begin{align} -->
<!-- Y_i &=       \alpha + \int_a^b \beta(s)X_i(s)ds+\varepsilon_i\\ -->
<!-- Y_i &\approx \alpha + \sum_{k=1}^Kc_k x_{ik} +\varepsilon_i -->
<!-- $$ -->
